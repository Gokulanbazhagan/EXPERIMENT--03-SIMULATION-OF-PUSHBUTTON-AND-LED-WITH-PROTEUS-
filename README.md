...
int main(void)
{
  ...
  while (1)
  {
    ...
    if(pb==0)
    {HAL_GPIO_Writepin(GPIOA,GPIOA_PIN_5,GPIO_PIN_SET);
    HAL_Delay(100);
    HAL_GPIO_Writepin(GPIOA,GPIOA_PIN_5,GPIO_PIN_RESET);
    HAL_Delay(100);
    }
    else
    {
    	HAL_GPIO_Write_pin(GPIOA,GPIO_PIN_RESET);
		HAL_Delay(500);
    }
  }
}
...
static void MX_GPIO_Init(void)
{
  ...
  __HAL_RCC_GPIOA_CLK_ENABLE();
   _HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4|GPIO_PIN_5, GPIO_PIN_RESET);
...
## Result :
Interfacing a digital output and digital input  with ARM microcontroller are simulated in proteus and the results are verified Successfully.
